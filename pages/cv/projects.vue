  ...
  <v-row>
      <v-col cols="3">
        <CvProjects
          ...
          :technologyUsed="['Python', 'Flask', 'Celery', 'Mysql', 'Javascript', 'Ethereum', 'Blockchain', 'RabbitMQ', 'Redis', 'Git', 'Linux', 'Nginx', 'Uwsgi']"
          amountOfMonths="3 måneder"
          yearFromTo="2019"
        >
          <p class="text-left title">
            Jobben handlet om å sette opp en kobling mellom et system som utførte automatisk kjøp og salg av kryptovalutaen
            <a
              target="_blank"
      ...
      <v-col cols="3">
        <CvProjects
          ...
          yearFromTo="2017-"
          imageUrl="https://i.gyazo.com/16d83ff79997b114949766dda140fa53.png"
          :technologyUsed="['Python', 'Flask', 'Java', 'Spring', 'Chalice', 'Zappa', 'Vue', 'Linux', 'AWS', 'Uwsgi', 'Heroku', 'Mysql', 'Gmail API', 'Web scraping', 'Celery', 'Task queue', 'JWT', 'Microservice architecture', 'Git', 'Github', 'Laget en tjeneste som er inspirert av Jenkins som dekker mine behov ']"
        >
          <p
            class="text-left"
          >En tjeneste som gjør det veldig lett for personer som driver med kjøp og salg av produkter (Dropshipping). Ved å utnytte de fleste butikkers "90-dagers prismatch",</p>

          <p
            class="text-left title"
          >Henter inn alle kjøp som blir gjort av brukeren via Gmail, og legger produktene inn i systemet.</p>

          <p
            class="text-left"
          >deretter vil den følge med om prisene endrer seg, og gir beskjed om noe har gått ned i pris.</p>

          <p
            class="title text-left"
          >Fokuset har vært at nettsiden skal være så skalerbar og vedlikeholdsfri som mulig.</p>
          <p
            class="text-left"
          >I tillegg holder den kontroll på alle gavekortene, og holder balansene oppdatert. Gavekortene blir hentet fra brukerens epost(er) og lagt inn i systemet.</p>
      ...
      <v-col cols="3">
        ...
        >
          ...
          <p
            class="text-left"
          >Dette er en aktivitet hovedsaklig arrangert av Askøy kommune, som strekker seg over 3 dager i sommerferien.</p>
          <p
            class="text-left"
      ...
      <v-col cols="3">
        <CvProjects
          ...
          yearFromTo="2018"
          imageUrl="https://lh3.googleusercontent.com/jKIF7dj8Qs3_Tnuaq-vLBe_kdvsyF55pR4ymNW5u3-W0KdkhM_ymAsfWymRMIH6JT_Y"
          :technologyUsed="['Python', 'Mysql', 'Windows Server']"
        >
          <p
            class="text-left title"
          >Dette oppdraget besto av mange små prosjekter som de ønsket utført for å effektivisere sin drift.</p>
          <p
            class="text-left"
      ...
      <v-col cols="3">
        <CvProjects
          ...
          :technologyUsed="['Python', 'Flask', 'Heroku']"
        >
          <p class="text-left title">
            Utvilker for
      ...
      <v-col cols="3">
        <CvProjects
          ...
          amountOfMonths="Pågående"
          yearFromTo="2017-"
          imageUrl="https://media.licdn.com/dms/image/C560BAQHOtgKbYPRl-A/company-logo_200_200/0?e=2159024400&v=beta&t=DdBIzHQEoObqEQefFfb1riLbHDQ8w-VrqFpMSozGwxw"
          description="drift og vedlikehold"
          :technologyUsed="['Linux']"
        >
          <p
            class="text-left title"
          >Drift av en server som er fysisk basert i Norge for en bedrift som driver med testing av sending av SMS-er.</p>
          <p
            class="text-left"
          >Dette består for det meste av feilsøking og fakturering til norske mobilleverandører.</p>

          <p class="text-left title">
            Målet er å være et bindeledd mellom
            <a
              href="https://3gproxy.com/"
              target="_blank"
