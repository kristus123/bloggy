<template>
  <div class="mx-0 my-16">
    <v-icon class="pb-0 ma-0 mt-2" x-large>mdi-format-quote-open</v-icon>
    <center>
      <p style="font-size: 20px" class="font-weight-thin ma-0 pa-0">
        {{ quote }}
      </p>
      <p
        v-if="person != null"
    ...
    <p class="text-right">
      <v-icon class="pa-0 ma-0" x-large>mdi-format-quote-close</v-icon>
    </p>
  </div>
</template>
<script>
